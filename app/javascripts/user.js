...
console.log(_contracts)
                ...
                $contracts.empty(); // clean the table before refresh
                 ...
                 $contracts_to_user.empty(); // clean the table before refresh
...
info= _contract[8];
var history= _contract[9];
var $infoall = info +" <br> " + history;//"In progress";
//console.log(_contract[9]);
...
<div class="ui card">
  <div class="content">
    <div class="header">Escrow Contract</div>
  </div>
  <div class="content">
    <h4 class="ui sub header">From ${$accountLogoFrom} to ${$accountLogoTo}</h4>
    <div class="ui small feed">
    <div class="event">
        <div class="content">
          <div class="summary">
              <a>Elliot</a> put to Escrow  400 ETH for <a>Joe</a>
          </div>
        </div>
      </div>
      <div class="event">
        <div class="content">
          <div class="summary">
             <a>Joe</a> send to <a>Elliot</a> 100kg Apples 
          </div>
        </div>
      </div>
      <div class="event">
        <div class="content">
          <div class="summary">
             When <a>Elliot</a> recive Apples he release founds to <a>Joe</a>.
          </div>
        </div>
      </div>
      <div class="event">
        <div class="content">
          <div class="summary">
          All disputes resolve Escrow. <br>
             Escrow Arbitrage: <a>Helen Troy</a> 
          </div>
        </div>
      </div>
    </div>
...
<div class="ui card">
  <div class="content">
    <div class="header">Invoice Contract</div>
  </div>
  <div class="content">
    <h4 class="ui sub header">$accountLogoFrom to $accountLogoTo</h4>
    <div class="ui small feed">
      <div class="event">
        <div class="content">
          <div class="summary">
             <a>Elliot</a> must sent to <a>Jenny</a> 100kg Apples 
          </div>
        </div>
      </div>
      <div class="event">
...
$stat = parseInt(_contract[7]);

//testing begins
                    // Append fetched contracts to table.
if((getAccount() == parseInt(_contract[5]))){
var stepinter = ["","","","","","",""];
var stepbutton = ["","","","","","",""];

switch ($stat) {
                        case 1:
                            $stattxt = `<div class="title">Escrow Contract sended to ${$accountLogoTo}</div>
                                          <div class="description"> <button class="ui primary negative button changeInfo">cancel</button></div>`;
                              var stepinter = ["disabled","active","disabled","disabled","disabled","disabled","disabled"];  
                              stepbutton[1] =  `<button class="ui primary negative button changeInfo ">cancel</button> `;        
                            break;
                        case 2:
                            $stattxt = `<div class="title">Escrow Contract Accepted by ${$accountLogoTo}</div>
                                          <div class="description"> founds: 
                                          <button class="ui primary button checkInfo" style="margin-right:2em;">Release</button>
                                          <button class="ui primary negative button changeInfo">Withdraw</button></div>`;
                                          var stepinter = ["disabled","completed","active","disabled","disabled","disabled","disabled"];
                            ...
                            break;
                        case 3:
                                $stattxt = `<div class="title">Escrow Contract Finish by ${$accountLogoTo}</div>
                                          <button class="ui primary button checkInfo" style="margin-right:2em;">Release founds</button>
                                          <button class="ui primary negative button changeInfo">Initiate arbitrage</button></div>`;

                                          var stepinter = ["disabled","completed","completed","active","disabled","disabled","disabled"];
  
                                stepbutton[3] =  `<div class="ui buttons">
                                          <button class="ui button orange">Withdraw</button>
                                          <div class="or"></div>
                                          <button class="ui positive button active">Release</button>
                                        </div> `; 
                            break;
                        case 4:
                                $stattxt = `<div class="title">Escrow Contract Finish by ${$accountLogoTo}</div>
                                          ...
                                          var stepinter = ["disabled","completed","completed","completed","active","disabled","disabled"];
  
                                stepbutton[4] =  `<div class="ui buttons">
                                          <button class="ui button red">Arbitrage</button>
                                          <div class="or"></div>
                                          <button class="ui positive button active">Release</button>
                                        </div> `; 
                            break;
                            case 5:
                                          ...
                                          var stepinter = ["disabled","completed","completed","completed","completed","active","disabled"];
  
                                stepbutton[5] =  `<a class="ui red tag label">Arbitrage in progress</a>`; 
                            break;
                            case 6:
                                ...
                                stepbutton[5] =  `<a class="ui green tag label">Arbitrage in refund  funds to you!</a>`; 
                            break;
                        }
...
<div class="ui  vertical steps ">
                                      <div class="${stepinter[1]} step">
                                        <i class="mail icon"></i>
                                        <div class="content">
                                          <div class="title">Escrow Contract sended to ${$accountLogoTo}</div>
                                          <div class="description"> ${stepbutton[1]}</div>
                                        </div>
                                      </div>
                                      <div class="${stepinter[2]} step">
                                        <i class="truck icon"></i>
                                        <div class="content">
                                          <div class="title">Accepted and started</div>
                                          <div class="description">${stepbutton[2]}
                                      ...
                                      <div class="${stepinter[4]} step">
                                        <i class="payment icon"></i>
                                        <div class="content">
                                          <div class="title">Need payment </div>
                                          <div class="description">
                                          ${stepbutton[4]}</div>
                                        </div>
                                      </div>
                                       <div class="${stepinter[5]} step">
                                        <i class="law icon"></i>
                                        <div class="content">
...
switch ($stat) {
                        case 1:
                              ...
                              stepbutton[1] =  `<div class="ui buttons">
                                          <button class="ui button orange">Cancel</button>
                                          <div class="or"></div>
                                          <button class="ui positive button active">Accept</button>
                                        </div> `;       
                            break;
                        case 2:
                              var stepinter = ["disabled","completed","active","disabled","disabled","disabled","disabled"];
                              ...
                              stepbutton[2] =  `<div class="ui buttons">
                                          <button class="ui button orange">Cancel</button>
                                          <div class="or"></div>
                                          <button class="ui positive button active">Done</button>
                                        </div> `; 
                        ...
                        case 3:
                                ...
                                stepbutton[3] =  `<a class="ui green tag label">Waiting founds release !</a>`; 
                            break;
                        case 4:
                                ...
                                stepbutton[4] =  `<div class="ui buttons">
                                          <button class="ui button red">Arbitrage</button>
                                          <div class="or"></div>
                                          <button class="ui black button active">Cancel</button>
                                        </div> `; 
                            break;
                            case 5:
...
<div class="ui  vertical steps ">
                                      <div class="${stepinter[1]} step">
                                        <i class="mail icon"></i>
                                        <div class="content">
                                          <div class="title">Escrow Contract sended from ${$accountLogoFrom}</div>
                                          <div class="description"> ${stepbutton[1]}</div>
                                        </div>
                                      </div>
                                      <div class="${stepinter[2]} step">
                                        <i class="truck icon"></i>
                                        <div class="content">
                                          <div class="title">Make your part</div>
                                          <div class="description">${stepbutton[2]}
...
//testing ends
    ...
    var $contracts_to_user=$('#contracts_to_user'); // Gets table body
